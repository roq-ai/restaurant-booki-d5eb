  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Restaurant Booking Engine: Your one-stop solution for effortless table reservations and seamless restaurant management. Empowering customers and staff alike."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Restaurant Booking Engine: Your one-stop solution for effortless table reservations and seamless restaurant management. Empowering customers and staff alike.`}
            </Text>
            <Box
